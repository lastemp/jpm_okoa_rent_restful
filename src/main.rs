...
// reponse: A text/plain content type is expected.
...
async fn process_ussd_actions(form: web::Form<InputData>, data: web::Data<Pool>) -> String {
    ...
    if is_registered {
        ...
        let response_data =
            process_unregistered_client_requests(&data, &session_id, &phone_number, text);
...
fn get_menu_1_sub_menu_data(data: &web::Data<Pool>, mobile_no: &String, text: &String) -> String {
    if text.replace(" ", "").len() == 0 {
        ...
        let response_data = match vector_length {
            2 =>
            //Index 1
            {
                ...
                if tenant_code.replace(" ", "").len() == 0 {
                    ...
                    let response_data =
                        generate_ussd_response_message(&response_data.to_string(), false);
            ...
            //Index 3
            {
                ...
                if !is_valid {
                    let mut sub_menu_data = String::from("");
                    let sub_menu_1 =
                        String::from("Please note that the minimum amount is Ksh 100.");
                    let sub_menu_2 = String::from("0:Back 00:Home");
                ...
                if !is_valid {
                    let mut sub_menu_data = String::from("");
                    let sub_menu_1 =
                        String::from("Please note that the maximum amount is Ksh 15,000.");
                    let sub_menu_2 = String::from("0:Back 00:Home");
            ...
            //Index 4
            {
                ...
                if input.eq("1") {
                    let mut sub_menu_data =
                        String::from("Please note that you you cancelled the request.");
            ...
            //Index 5
            {
                ...
                if pin.eq("1234") {
                    let sub_menu_1 = String::from(
                        "Dear Customer, we acknowledge receipt of your Okoa Rent submission.",
                    );
                    let sub_menu_2 = String::from(
                        "It is being processed and you will be notified once complete.",
                    );
                    ...
                    let amount = match amount_s.parse::<i32>() {
                        Ok(a) => a,
                        Err(e) => 0,
                    };

                    db_layer::create_okoa_rent_data(
                        data,
                        tenant_code,
                        house_code,
                        amount,
                    ...
                    let _from: String =
                        db_layer::get_settings_details(data, String::from("senderidsmsprsp"));
                    let user_name: String =
                        db_layer::get_settings_details(data, String::from("usernamesmsprsp"));
                    let api_key: String =
                        db_layer::get_settings_details(data, String::from("apikeysmsprsp"));
                    let api_url: String =
                        db_layer::get_settings_details(data, String::from("urlsmsprsp"));
                    ...
                    tokio::spawn(async move {
                        ...
                        api_layer::send_sms_message(
                            data_1, _message, _to, _from, user_name, api_key, api_url,
                        )
                        .await;
                    });
    ...
    if text.replace(" ", "").len() == 0 {
        ...
        let response_data = match vector_length {
            ...
            //Index 5
            {
                ...
                if pin.eq("1234") {
                    let sub_menu_1 = String::from(
                        "Dear Customer, we acknowledge receipt of your Okoa Mortgage submission.",
                    );
                    let sub_menu_2 = String::from(
                        "It is being processed and you will be notified once complete.",
                    );
                    ...
                    db_layer::create_okoa_mortgage_data(
                        data,
                        mortgagor_code,
                        house_code,
                        amount,
        ...
        let response_data = match vector_length {
            ...
            //Index 1
            {
                ...
                if rent_mortgage_code.replace(" ", "").len() == 0 {
                    let response_data =
                        "Please note that you did not enter Okoa Rent\\Mortgage number.";
                    let response_data =
                        generate_ussd_response_message(&response_data.to_string(), false);
                ...
                sub_menu_data.push_str("\n");
                sub_menu_data.push_str(&String::from(
                    "Check Balance for Okoa Rent\\Mortgage number ",
                ));
        ...
        let response_data = match vector_length {
            ...
            //Index 2
            {
                ...
                if input.eq("1") {
                    ...
                    let sub_menu_1 = String::from(
                        "Dear Customer, we acknowledge receipt of your Get Statement submission.",
                    );
                    let sub_menu_2 = String::from(
                        "It is being processed and you will be notified once complete.",
                    );
                    ...
                    db_layer::create_get_statement_data(
                        data,
                        full_statement,
                        mini_statement,
                        mobile_no.to_string(),
...
fn get_menu_1_sub_menu_data_unregistered_client(
    data: &web::Data<Pool>,
    mobile_no: &String,
    text: &String,
) -> String {
        ...
        let response_data = match vector_length {
            ...
            //Index 1
            {
                ...
                if national_id.len() == 0 {
                    ...
                    let mut sub_menu_data = String::from("");
                    let sub_menu_1 = String::from(
                        "Please note that national ID number must have 7 or 8 digits.",
                    );
                    let sub_menu_2 = String::from("00:Home");
                ...
                let valid_national_id = match national_id.parse::<i64>() {
                    Ok(a) => {
                        if a > 0 {
                            true
                        } else {
                ...
                if !valid_national_id {
                    let mut sub_menu_data = String::from("");
                    let sub_menu_1 = String::from(
                        "Please note that national ID number must contain digits only.",
                    );
                    let sub_menu_2 = String::from("00:Home");
            ...
            //Index 2
            {
                ...
                if !full_names.contains(" ") {
                    let mut sub_menu_data = String::from("");
                    let sub_menu_1 =
                        String::from("Please enter firstname and lastname separated with a space.");
                    let sub_menu_2 = String::from("00:Home");
            ...
            //Index 4
            {
                ...
                if input.eq("1") {
                    ...
                    db_layer::create_self_registration_data(
                        data,
                        national_id,
                        full_names,
                        house_code,
...
fn get_sub_menu_data(data: &web::Data<Pool>, mobile_no: &String, text: &String) -> String {
    ...
    if text.contains("*") {
        ...
        let response_data = match menu_selected.as_str() {
            "1" =>
            //menu_1
            {
        ...
        let response_data = match text.as_str() {
            "1" =>
            //menu_1
            {
                get_menu_1_sub_menu_data(data, mobile_no, text)
...
fn get_sub_menu_data_unregistered_client(
    data: &web::Data<Pool>,
    mobile_no: &String,
    text: &String,
) -> String {
...
fn process_client_requests(
    ...
    db_layer::create_ussd_session_details(
        data,
    ...
    let caller_action: String =
        db_layer::get_ussd_session_details(data, &session_id, &phone_number);
...
fn process_unregistered_client_requests(
    data: &web::Data<Pool>,
    session_id: &String,
    phone_number: &String,
    text: &String,
    ...
    if caller_action.replace(" ", "").len() == 0 {
        ...
        //Lets process sub menu selection by user
        let response_data =
            get_sub_menu_data_unregistered_client(&data, &phone_number, &caller_action);
...
fn validate_numeric(input: &String) -> bool {
    ...
    let input_value = match input.parse::<i32>() {
        Ok(a) => a,
        Err(e) => 0,
    };
...
fn validate_minimum_amount(input: &String) -> bool {
    ...
    if input_value > 0 && input_value >= minimum_amount {
        is_valid = true
    }
...
fn validate_maximum_amount(input: &String) -> bool {
    ...
    if input_value > 0 && input_value <= maximum_amount {
        is_valid = true
    }
